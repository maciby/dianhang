...
import com.dianhang.system.mapper.SysMenuMapper;
import com.dianhang.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
	...
	@Override
	public List<Map<String, Object>> roleMenuTreeData(SysRole role, SysUser sysUser) {
		String roleId = role.getRoleId();
		List<Map<String, Object>> trees = new ArrayList<Map<String, Object>>();
		...
		if(sysUser.isAdmin()) {
			...
			menuList = menuMapper.selectMenuAllByUserId(sysUser.getUserId());
		}
		if (StringUtils.isNotNull(roleId)) {
			List<String> roleMenuList = menuMapper.selectMenuTree(roleId);
			trees = getTrees(menuList, true, roleMenuList, true);
...
//			Long menuId = StringUtils.isNull(menu.getMenuId()) ? -1L : menu.getMenuId();
			...
			if (StringUtils.isNotNull(info) && !menu.getMenuId().equals(info.getMenuId())) {
