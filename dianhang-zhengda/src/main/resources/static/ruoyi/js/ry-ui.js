...
(function ($) {
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
                ...
                $('#bootstrap-table').bootstrapTable({
        			...
        			showNoDataInfo: $.common.visible(options.showNoDataInfo),
        ...
        treeTable: {
            ...
            init: function(options) {
                ...
                var treeTable = $('#bootstrap-tree-table').bootstrapTreeTable({
        	        ...
        	        rootIdValue: options.rootIdValue,         			// 设置根节点id值----可指定根节点，默认为null,"",0,"0"
        	    	type: 'get',                                        // 请求方式（*）
        	        url: options.url,                                   // 请求后台的URL（*）
    	...
    	modal: {
            ...
            // 确认窗体
            notice: function (content, callBack) {
        ...
        operate: {
        	// 异步提交表单
        	ajaxSubmit: function(formObj, callback){
...
//						var address = formElement.address.value;  //访问jqForm的DOM元素
        			...
        			success : function(responseText) {
        				...
        				if(callback){
            	        	...
            	        	$.operate.ajaxSuccess(responseText);
        				}
        			},
        			error : function(XMLResponse) {
//        				$.modal.alertError("错误信息："+XMLResponse.responseText);
//                    	$.modal.closeLoading();
                    	$.operate.ajaxFailure($.parseJSON(XMLResponse.responseText));
        			}
        		};
